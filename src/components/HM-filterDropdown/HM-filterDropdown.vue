              ...
              >
                ...
                >
                  <view
                    ...
                    :class="{
                      on: activeMenuArr[page_index][1] == second_index,
                    }"
                  >
                    <view
                      class="menu-name"
                ...
                >
                  ...
                  >
                    <view
                      ...
                      :class="{
                        on: activeMenuArr[page_index][2] == sub2_index,
                      }"
                    >
                      <view
                        class="menu-name"
  ...
  methods: {
    ...
    selectHierarchyMenu(page_index, level1_index, level2_index, level3_index) {
      ...
      if (tmpMemu.submenu.length == 0) {
        ...
        if (
          tmpMemu.submenu.length == 0 ||
          this.menu[page_index].type == "hierarchy"
        ) {
          this.selectedMemu(
            page_index,
            level1_index,
    ...
    selectedMemu(page_index, level1_index, level2_index, level3_index) {
      let sub =
        this.subData[page_index].submenu[level1_index].submenu[level2_index];
      if (this.updateMenuName) {
    ...
    selectFilterLabel(page_index, box_index, label_index) {
      let find_index =
        this.activeMenuArr[page_index][box_index].indexOf(label_index);
      if (find_index > -1) {
